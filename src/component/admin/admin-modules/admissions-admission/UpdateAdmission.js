...
export default function UpdateAdmission() {
    ...
    const updateAdmission = async () => {
        ...
        // dòng này là gọi API 
        const response = await API.put(endpoints["admission"] + `${admissionId}/`, data).then(res => {
        ...
        <div className="content-wrapper">
            <div className="card card-primary">
                <div className="card-header">
                    <h3 className="card-title">Cập nhật tin tuyển sinh</h3>
                </div>
                <form>
                    ...
                    <div className="card-footer text-center">
                        ...
                        <button type="button" className="btn btn-primary" onClick={updateAdmission}>
                            Cập nhật
                        </button>
                    </div>
                </form>
