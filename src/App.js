...
import AdmissionIndex from './component/admin/admin-modules/admission-admission/IndexAdmission';
import AdmissionCreate from './component/admin/admin-modules/admission-admission/CreateAdmission';
